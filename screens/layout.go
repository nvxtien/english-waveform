...
func makeBorderLayout() *fyne.Container {
	...
	content := fyne.NewContainerWithLayout(layout.NewFixedGridLayout(fyne.NewSize(590, 290)),
		canvas.NewRasterWithPixels(fractal.mandelbrot),
	)
...
func LayoutPanel() fyne.CanvasObject {
	return widget.NewTabContainer(
		widget.NewTabItem("Waveform 2", makeBorderLayout()),
	)
}
